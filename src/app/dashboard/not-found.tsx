...
export default function DashboardNotFound() {
  return (
    <div className="flex flex-col items-center justify-center py-20">
      ...
      >
        <div className="w-20 h-20 bg-violet-50 dark:bg-violet-900/20 rounded-3xl flex items-center justify-center mx-auto mb-5">
          <FileQuestion className="w-10 h-10 text-violet-500" />
        </div>
